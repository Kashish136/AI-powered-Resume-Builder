            ...
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    ...
                    <div className="flex gap-2">
                       {!user ?( <><Link to = '/app?state=login' className="hidden md:block px-6 py-2 bg-green-500 hover:bg-green-700 active:scale-95 transition-all rounded-full text-white">
                            Get started
                        </Link>


                     <Link to= '/app?state=register' className="hidden md:block px-6 py-2 border active:scale-95 hover:bg-slate-50 transition-all rounded-full text-slate-700 hover:text-slate-900 " >
                            Login
                        </Link>  </>):(

                      <Link to = '/app' className = 'hidden md:block px-8 py-2 bg-green-500 hover:bg-green-700 active:scale-95 transition-all rounded-full text-white'> Dashboard </Link>)}
                    </div> 
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <p className="py-6 text-slate-600 mt-14">Trusted by people, working in</p>
