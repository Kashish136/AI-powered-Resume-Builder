import { UploadCloudIcon ,PlusIcon,TrashIcon, FilePenLineIcon , PencilIcon , XIcon, LoaderCircleIcon} from 'lucide-react'
...
const uploadResume = async(e) =>{
   ...
   console.log("RESUME:", resume, resume instanceof File)
...
const deleteResume = async(resumeId) => {
  ...
  return (
    ...
    <p className = 'text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden'>Welcome , Kashish</p>
    ...
    <p className = 'text-sm group-hover: text-purple-600 transition-all duration-300'>
      Upload Existing    </p>
        ...
        {
            showCreateResume &&(
                <form onSubmit = {createResume} onClick={(e) => setShowCreateResume(false)}className = 'fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center'>
                    ...
                    <XIcon className = 'absolute top-4 right-4 text-slate-400 hover:text-slate-600 cursor-pointer transition-colors' onClick={() => {setShowCreateResume(false); setTitle('') ; e.stopPropagation();setEditResumeId("");  }}/>
